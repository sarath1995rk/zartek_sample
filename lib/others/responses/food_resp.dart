...
class CategoryDish {
  ...
  @override
  String toString() {
    return 'CategoryDish{dishId: $dishId, dishName: $dishName, dishPrice: $dishPrice, dishImage: $dishImage, dishCurrency: $dishCurrency, dishCalories: $dishCalories, dishDescription: $dishDescription, dishAvailability: $dishAvailability, dishType: $dishType, nexturl: $nexturl, addonCat: $addonCat}';
  }
  ...
  factory CategoryDish.fromJson(Map<String, dynamic> json) => CategoryDish(
        ...
        addonCat: json["addonCat"] == null
            ? null
            : List<AddonCat>.from(json["addonCat"].map((x) {
                return AddonCat.fromJson(x);
              })),
      );
